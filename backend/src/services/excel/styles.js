const colors = {
    ...
    navyMedium: "1E293B",
    navyLight: "334155",
    primary: "0284C7", // Cyan / Electric Blue
    primaryLight: "E0F2FE",
...
exports.applySheetTitle = (sheet, titleText, subtitleText = "", colSpan = 8) => {
    ...
    if (subtitleText) {
        ...
        subCell.fill = {
            type: "pattern",
            pattern: "solid",
            fgColor: { argb: colors.navyMedium }
        };
        subCell.alignment = {
            horizontal: "left",
            vertical: "middle",
...
/**
 * Formats a table header row with bold white text on navy background
 */
 ...
 */
exports.applySectionHeader = (sheet, rowNumber, title, colSpan = 4) => {
...
/**
 * Applies zebra striping across data rows
 */
...
/**
 * Formats a summary / cumulative total row with bold font and top double border
 */
...
/**
 * Ensures gridlines are visible and columns are cleanly autofitted
 */
